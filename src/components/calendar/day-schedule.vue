<template>
    <div class="ds-daySchedule" :style="{height:dayTimeHeight*24+'rem'}" ref="daySchedule">
        ...
        <div class="ds-schedule" :style="{height:dayTimeHeight*24+'rem'}">
    ...
    export default {
        ...
        methods: {
            ...
            setStyle: function (seg) {
                ...
                props.top = seg.top + 'rem'
                props.bottom = seg.bottom + 'rem'
                if (seg.color) {
                    ...
                    for (let m = 0, len = scheduleItems.length; m < len; m++) {
                        ...
                        if (scheduleItem && scheduleItem.startDate && scheduleItem.startDate instanceof Date && scheduleItem.endDate && scheduleItem.endDate instanceof Date) {
                            ...
                            if (startTime <= currentEndTime && endTime >= currentStartTime) {
                                ...
                                if (scheduleItem.show === undefined || scheduleItem.show === null) {
    ...
    .ds-daySchedule {
        ...
        .ds-schedule {
            ...
            .ds-schedule-item {
                ...
                border-left: rgb(224, 111, 46) 0.1rem solid;
                .ds-schedule-subject {
                    color: black;
